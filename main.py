...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI("NUYUL DOGECOIN".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("INSTAGRAM : instagram.com/ojan_ghost")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPq+"0janGh05t HANDMADE".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  if UravxBuCwNMpYWTzKhPg(UravxBuCwNMpYWTzKhPs)<2:
   UravxBuCwNMpYWTzKhPI("Usage: python main.py 62xxxxxxxxxxx",end="\n\n")
  ...
  async def UravxBuCwNMpYWTzKhPL(event):
   UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPd+"IKLAN HABIS TERDETEKSI"+UravxBuCwNMpYWTzKhPG)
   UravxBuCwNMpYWTzKhcg("SHUTDOWN...")
